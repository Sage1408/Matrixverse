      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-[#161B22] border border-[#30363D] rounded-2xl p-8 flex flex-col">
            ...
            <a href="/register" className="w-full border border-[#30363D] text-white font-semibold py-3 rounded-full text-sm text-center hover:border-[#00D4FF] hover:text-[#00D4FF] transition-colors duration-200">
              Get Started Free
            </a>
          </div>
          ...
          <div className="bg-[#161B22] border-2 border-[#00D4FF] rounded-2xl p-8 flex flex-col relative">
            ...
            <a href="/register" className="w-full bg-[#00D4FF] text-[#0D1117] font-bold py-3 rounded-full text-sm text-center hover:bg-[#00b8d9] transition-colors duration-200">
